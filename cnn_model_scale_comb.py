...
# -------------------------------
# Save UNSEEN prediction metadata
# -------------------------------

meta_pred_unseen = meta_test_unseen.copy()

meta_pred_unseen["y_true"] = label_encoder.inverse_transform(y_test_unseen)
meta_pred_unseen["y_pred"] = label_encoder.inverse_transform(y_pred_unseen)
meta_pred_unseen["pred_confidence"] = y_prob_unseen.max(axis=1)
...
# -------------------------------
# Save SEEN prediction metadata
# -------------------------------

meta_pred_seen = meta_test_seen.copy()

meta_pred_seen["y_true"] = label_encoder.inverse_transform(y_test_seen)
meta_pred_seen["y_pred"] = label_encoder.inverse_transform(y_pred_seen)
meta_pred_seen["pred_confidence"] = y_prob_seen.max(axis=1)
